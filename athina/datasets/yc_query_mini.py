data = [
    # Incorrect - Unfaithful
    {
        ...
        "contexts": ["Y Combinator has invested in companies in various fields like FinTech, Healthcare, AI, etc."],
    ...
    },
    {
        ...
        "contexts": ["Y Combinator is located in Mountain View, California."],
    ...
    # Incorrect - Insufficient Context + Unfaithful
    {
        ...
        "contexts": ["Y Combinator invests $500k in 200 startups twice a year."],
    ...
    },
    {
        ...
        "contexts": ["Y Combinator was founded in March 2005 by Paul Graham, Jessica Livingston, Trevor Blackwell, and Robert Tappan Morris."],
    ...
    # Correct answers
    {
        ...
        "contexts": ["Y Combinator invests in startups from all over the world."],
    ...
    },
    {
        ...
        "contexts": ["YC invests $150k for 7%."],
        "response": "$150k",
    ...
    },
    {
        ...
        "contexts": ["Y Combinator's motto is 'Make something people want'."],
